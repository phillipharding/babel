<#
    ...
    .\provision-corpcomms.ps1 -URL "https://rbcom.sharepoint.com/sites/dev-pah" -CredentialLabel "RB.COM SPO" -Configuration "0"
    .\provision-corpcomms.ps1 -URL "https://platinumdogsconsulting.sharepoint.com/sites/publishing" -CredentialLabel "SPO" -Configuration "0"
    .\provision-corpcomms.ps1 -URL "http://pub.pdogs.local/" -CredentialLabel "OnPrem" -Configuration "0"
...
$configurationName = "CorpComms"
$configurationId = $Configuration
$configurationFiles = @("corpcomms")
