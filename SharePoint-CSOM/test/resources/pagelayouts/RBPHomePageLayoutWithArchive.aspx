...
<asp:Content ContentPlaceHolderId="PlaceHolderPageTitle" runat="server">
	...
	<SharePointWebControls:UIVersionedContent UIVersion="4" runat="server">
		<ContentTemplate> <SharePointWebControls:FieldValue FieldName="Title" runat="server"/></ContentTemplate>
	</SharePointWebControls:UIVersionedContent>
</asp:Content>
	   ...
	   <div class="rb_wrapper"><!-- Wrapper Start -->
			...
			<div class="rbp_3g2">
				<div class="pod" id="news">
					...
					<div class="body">
						<RBNews:NewsRotatorWebPart ID="NewsRotatorWebPart" runat="server" spWeb="RBP/News" __WebPartId="{0D41C48C-ADEB-492E-AC34-F571850A6F81}"></RBNews:NewsRotatorWebPart>
					<div id="ArchiveDiv">
								<h3>
									<SharePointWebControls:SPLinkButton runat="server" NavigateUrl="~sitecollection/news/">Full Archive</SharePointWebControls:SPLinkButton>
								</h3>
						</div>
			...
			<div class="rbp_3g2">
				<div class="pod">
					...
					<div class="body">
						<RBNews:AnnouncementsWebPart ID="AnnouncementsWebPart" runat="server" spWeb="News" ListName="Announcements" __WebPartId="{B0224272-66AA-4DC8-9AF5-756A92742C01}"></RBNews:AnnouncementsWebPart>
					<div id="AnnouncementsArchiveDiv">
								<h3>
									<SharePointWebControls:SPLinkButton runat="server" NavigateUrl="~sitecollection/news/Pages/announcements.aspx">Full Archive</SharePointWebControls:SPLinkButton>
								</h3>
						</div>
				...
				<div class="rbp_3g1">
					<WebPartPages:WebPartZone runat="server" FrameType="None" ID="GPZone" Name="GPZone" Title="Guiding Principles Zone"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
				</div>
				<div class="rbp_3g1 r">
					<div class="pod">
						<div class="head">
							<div class="rules">
								<span>
								<SharePointWebControls:TextField FieldName="RB_RBP_BannerText5" runat="server"></SharePointWebControls:TextField></span></div>
						</div>
						<div class="body">
							<div class="content">
								<PublishingWebControls:RichHtmlField FieldName="RB_RBP_PullOutHTML" runat="server"/>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="rbp_3g1">
			  <div class="search">
				<div class="searchbox"><input type="text" title="Search Indivior" placeholder="Search Indivior" /><a href="#" class="searchbtn">Search</a></div>
				<div class="searchbox"><input type="text" title="Find a Person" placeholder="Find a Person" /><a href="#" class="psearchbtn">Search</a></div>
			  </div>
			  <RBNav:LinksWebPart runat="server" ID="LinksWebPart" Title="Links" __WebPartId="{686662A5-5B7A-45B6-868B-8D2EEB32CE82}"></RBNav:LinksWebPart>
			</div>

			<div class="rbp_3g3" style="margin-left:0px!important;">
					<div class="rbp_3g1">
				...
				<div class="rbp_3g1" style="float:left;">
				
				<div class="pod">
							<div class="head" >
								<div class="KeyEvents">
									<span>
									<SharePointWebControls:TextField FieldName="RBP_Banner_Text_7" runat="server"></SharePointWebControls:TextField></span></div>
							</div>
							<div class="body" >
								<div class="content">
									<WebPartPages:WebPartZone runat="server" FrameType="None" ID="NewsZone1" Name="NewZone1" Title="New Zone1"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
								</div>
							</div>
					</div>

				</div>
				<div class="rbp_3g1" style="width:100px!important;" >
				
				<div class="pod">
							<div class="head" >
								<div class="MyFavourites">
									<span>
									<SharePointWebControls:TextField FieldName="RBP_Banner_Text_8" runat="server"></SharePointWebControls:TextField></span></div>
							</div>
							<div class="body" >
								<div class="content">
									<WebPartPages:WebPartZone runat="server" FrameType="None" ID="NewsZone2" Name="NewZone2" Title="New Zone1"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
								</div>
							</div>
					</div>
