...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	<PublishingWebControls:EditModePanel runat="server" id="EditModePanelDisp" PageDisplayMode="Display">
   <p>&nbsp;</p>
    <div class="rb_wrapper"><!-- Wrapper Start -->
     <div id="rb_breadcrumb"><Nav:BreadcrumbControl runat="server" ID="BreadcrumbControl"></Nav:BreadcrumbControl></div>
     <div id="rb_news">
      <div class="rb_3w printfull">
       <span class="rb_articledate"><SharePointWebControls:DateTimeField runat="server" FieldName="ArticleStartDate" /></span>
       <h1 class="rb_storyhead"><SharePointWebControls:TextField runat="server" FieldName="Title" /></h1>
       <div id="rb_story">
        <PublishingWebControls:RichImageField runat="server" FieldName="PublishingPageImage" />
  ...
  <PublishingWebControls:EditModePanel runat="server" id="EditModePanelEdit" PageDisplayMode="Edit">
    <div>
     <SharePointWebControls:DateTimeField runat="server" FieldName="ArticleStartDate" />
    </div>
    <div>
    ...
    <div>
     <PublishingWebControls:RichImageField runat="server" FieldName="PublishingRollupImage" />
    </div>
    <div>
