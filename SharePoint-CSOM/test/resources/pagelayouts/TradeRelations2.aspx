      ...
      <div class="pod">
		...
		<tr>
			<td valign="top" style="padding:0">
				<table cellpadding="4" cellspacing="0" border="0" width="100%">
					<tr>
						<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" width="75%" style="padding-right: 10px; padding-bottom: 10px;" colspan="3" valign="top">
					...
					<tr>
						<td width="75%" colspan="3" valign="top" style="padding:0">
							<table cellpadding="4" cellspacing="0" width="100%">
								<tr>
									<td width="50%" id="_invisibleIfEmpty" name="_invisibleIfEmpty" style="padding-bottom: 10px;" valign="top"> 
									<WebPartPages:WebPartZone runat="server" Title="<%$Resources:cms,WebPartZoneTitle_TopLeft%>" ID="TopLeftRow"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone> </td>
																	<td width="50%" id="_invisibleIfEmpty" name="_invisibleIfEmpty" style="padding-right: 10px; padding-bottom: 10px;; padding-left: 10px;" valign="top">																	</div>
							...
							<table cellpadding="4" cellspacing="0" width="100%">
								<tr>
									<td width="75%" id="_invisibleIfEmpty" name="_invisibleIfEmpty" style="padding-bottom: 10px; padding-right: 10px;" valign="top">
									<div class="head">
										<div class="Tools long">
										<h3>Trade Tools &amp; Resources</h3>
										</div>
									</div>
									<WebPartPages:WebPartZone runat="server" Title="FullMiddle" ID="FullMiddle"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone> 
									</td>
								</tr>
							</table>
						...
						<td width="33%" id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%"> 
						...
						<td widt="33%" id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" height="100%"> 
					...
					<tr>
						<td width="75%" id="_invisibleIfEmpty" name="_invisibleIfEmpty" colspan="3" valign="top"> 
			...
			<td id="_invisibleIfEmpty" name="_invisibleIfEmpty" valign="top" width="25%">
			<div class="head">
						<div class="TradeRelations short">
							<h3>Trade Relations</h3>
						</div>
			</div>
			<div class="TradeRelationsColumn">
		...
		<link href="/Style Library/RBPv2/css/Trade-Relations.css" rel="stylesheet"/>
